...
CAM3 = Cam.Cam(2, np.array([664.0, 28.0, 128.0]), np.array([-57.0 , 209.0, 134.0]),
               np.array([-56.0, 60.0, 80.5]), np.array([-57.0, 240.0, 50.5]), [154.0, 296.0], [347.0, 332.0],
               640.0,
               480.0, 30.0, 25.0, 1)
# Left camera
CAM4 = Cam.Cam(3, np.array([664.0, 269.0, 120.0]), np.array([-57.0 ,172.0 ,
                                                             93.0]),
               np.array([-56.0, 60.0, 80.5]), np.array([-57.0, 240.0, 50.5]), [201.0, 246.0], [392.0, 293.0],
               640.0,
               480.0, 30.0, 25.0, 0)

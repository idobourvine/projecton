...
CAM2 = Cam.Cam(1, np.array([-57.0, 252.0, 135.0]), np.array([669.0, 117.0,
                                                              137.0]),
               np.array([668.5, 240.0, 69.5]), np.array([668.5, 60.0, 54.5]), [179, 305], [378, 330],
               640.0,
               480.0, 30.0, 25.0, 1)

CAM3 = Cam.Cam(2, np.array([664.0, 28.0, 128.0]), np.array([-57.0 , 252.0, 135.0]),
               np.array([-56.0, 60.0, 80.5]), np.array([-57.0, 240.0, 50.5]), [153.0, 280.0], [346.0, 316.0],
               640.0,
               480.0, 30.0, 25.0, 1)
# Left camera
CAM4 = Cam.Cam(3, np.array([664.0, 269.0, 120.0]), np.array([-57.0 , 226.0, 115.0]),
               np.array([-56.0, 60.0, 80.5]), np.array([-57.0, 240.0, 50.5]), [202.0, 235.0], [392.0, 381.0],
               640.0,
               480.0, 30.0, 25.0, 0)
